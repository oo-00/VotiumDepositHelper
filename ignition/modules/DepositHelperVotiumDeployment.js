...
module.exports = buildModule("DeployDepositHelperVotium", (m) => {
  ...
  // DepositHelperVotium constructor has three arguments
  const DepositHelperVotium = m.contract("DepositHelperVotium", [rewardToken, rewardNotifier, initialOwner]);

  return { DepositHelperVotium };
});